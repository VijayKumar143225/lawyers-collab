...
function LawyerLoginRegister() {
  ...
  return (
    <Container maxWidth="xs" style={{ backgroundColor: '#f0f0f0', padding: '20px', borderRadius: '8px' }}>
      <Box mt={5}>
        <Typography variant="h5" gutterBottom>Lawyer Register Page</Typography>
        <form onSubmit={handleSubmit(handleRegister)}>
          ...
          <Controller
            ...
            defaultValue=""
            render={({ field }) => (
              <TextField fullWidth label="Specialization" margin="normal" {...field} />
            )}
          />
          <Controller
            name="email"
